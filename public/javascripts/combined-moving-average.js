...
$(function() {
  ...
  source.addEventListener('message', function(e) {
    ...
    data.forEach(function(datum) {
      ...
      chart.series[0].addPoint([time, watts1], false, false, false);
      chart.series[1].addPoint([time, watts2], false, false, false);

      while (markers.length !== 0 && time >= markers[0].x) {
        var flag = markers.shift();
        chart.series[2].addPoint(flag, false, false, false);
      }
    });
